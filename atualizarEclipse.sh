...
packageName=eclipse-java-oxygen-3-linux-gtk-x86_64.tar.gz
...
wget http://mirror.nbtelecom.com.br/eclipse/technology/epp/downloads/release/oxygen/3/$packageName -O$destinationDownloadDir/$packageName
